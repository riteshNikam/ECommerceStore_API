...
// Get JWT setting form appsetting.json
var jwtSettings = builder.Configuration.GetSection("Jwt");

// Get JWT secret key
var keyString = jwtSettings["Key"] ?? throw new InvalidOperationException("JWT key is missing");

// Convert JWT secret key into byte array [ Required to sign JWT token ]
...
// changes to swagger so that I can pass auth token to it.
